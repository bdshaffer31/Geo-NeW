# Geo-NeW
General Geometry Neural Whitney Forms for PDEs on complex geometries
...
This repository provides a minimal implementation of the core methodology, it will be udpated with a training and evaluations example by 1/31/2026.
